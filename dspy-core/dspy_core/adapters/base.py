...
from dspy_core.adapters.types import History, Type
from dspy_core.adapters.types.base_type import split_message_content_for_custom_types
from dspy_core.adapters.types.reasoning import Reasoning
from dspy_core.adapters.types.tool import Tool, ToolCalls
from dspy_core.experimental import Citations
from dspy_core.signatures.signature import Signature
from dspy_core.utils.callback import BaseCallback, with_callbacks
...
class Adapter:
    ...
    def _get_tool_schemas(
        ...
        inputs: dict[str, Any],
    ) -> tuple[type[Signature], list[dict[str, Any]] | None]:
        """Extract tool call schemas from inputs when use_native_function_calling is enabled.

        Returns the (possibly modified) signature and a list of tool schemas in OpenAI function-call
        format, or None if native function calling is not being used.
        """
