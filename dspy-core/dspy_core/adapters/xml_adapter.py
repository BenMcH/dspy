...
from dspy_core.adapters.chat_adapter import ChatAdapter, FieldInfoWithName
from dspy_core.adapters.utils import format_field_value, translate_field_type
...
class XMLAdapter(ChatAdapter):
    ...
    def parse(self, signature: type[Signature], completion: str) -> dict[str, Any]:
        ...
        if fields.keys() != signature.output_fields.keys():
            from dspy_core.utils.exceptions import AdapterParseError
    ...
    def _parse_field_value(self, field_info, raw, completion, signature):
        from dspy_core.adapters.utils import parse_value
