...
from dspy_core import InputField, OutputField, Signature, infer_prefix
...
@pytest.mark.skip(reason="Requires dspy.Predict / dspy.configure / DummyLM - not available in dspy-core")
...
@pytest.mark.skip(reason="Requires dspy.Predict / dspy.configure / DummyLM - not available in dspy-core")
def test_basic_custom_type_with_predict():
    pass
...
@pytest.mark.skip(reason="Requires dspy.Predict / dspy.configure / DummyLM - not available in dspy-core")
def test_custom_type_from_different_module_with_predict():
    pass
...
@pytest.mark.skip(reason="Requires dspy.Predict / dspy.configure / DummyLM - not available in dspy-core")
def test_pep604_union_type_with_custom_types_with_predict():
    pass
