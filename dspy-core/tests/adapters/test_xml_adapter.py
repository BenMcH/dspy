...
from dspy_core.adapters.chat_adapter import FieldInfoWithName
from dspy_core.adapters.xml_adapter import XMLAdapter
...
def test_xml_adapter_code_output_with_lm():
    pass
