...
from dspy_core.adapters.baml_adapter import COMMENT_SYMBOL, INDENTATION, BAMLAdapter
...
def test_baml_adapter_code_output_with_lm():
    """Test BAMLAdapter with code as output field - requires dspy.LM."""
    pass
